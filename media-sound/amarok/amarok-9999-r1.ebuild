...
SRC_URI="https://github.com/vmatare/amarok.git"
...
PATCHES=(
	...
	"${FILESDIR}/0001-tests-conditionalize-SQL-tests-on-embedded-MYSQL.patch"
	"${FILESDIR}/0002-storage-Fix-for-MySQL-8.0-onward.patch"
)
