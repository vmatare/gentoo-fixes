...
RDEPEND="
	...
	!vulkan? ( >=media-libs/mesa-13.0.3[openmax] )
	vulkan? ( >=media-libs/mesa-13.0.3[openmax,-vulkan] media-libs/vulkan-loader )
	>sys-kernel/gentoo-sources-4.8.0
...
src_unpack() {
	...
	unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-utils_2.4.70-${PKG_REV}_amd64.deb"
	...
	if use opengl ; then
		# Install OpenGL
		unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-amdgpu1_2.4.70-${PKG_REV}_amd64.deb"
		unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-radeon1_2.4.70-${PKG_REV}_amd64.deb"
		...
		if use abi_x86_32 ; then
			unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-amdgpu1_2.4.70-${PKG_REV}_i386.deb"
			unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libdrm-amdgpu-pro-radeon1_2.4.70-${PKG_REV}_i386.deb"
	...
	if use vdpau ; then
		# Install VDPAU
		unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libvdpau-amdgpu-pro_13.0.3-${PKG_REV}_amd64.deb"
		
		if use abi_x86_32 ; then
			unpack_deb "amdgpu-pro-${PKG_VER_STRING}/libvdpau-amdgpu-pro_13.0.3-${PKG_REV}_i386.deb"
		fi
	fi
	
	# Install xorg drivers
	unpack_deb "amdgpu-pro-${PKG_VER_STRING}/xserver-xorg-video-amdgpu-pro_1.2.99-${PKG_REV}_amd64.deb"
